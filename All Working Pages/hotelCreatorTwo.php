...
//$con->close();
    ...
    $keywords = "standard" ." " . "luxury" ." " . "courtyard" ." ". $priceLux . " ".$priceStan;
	...
	if(mysqli_num_rows($hotelcheckI) >0 && mysqli_num_rows($hotelcheckJ) > 0){
        ...
        header("Location: hotelCreatorTwo.php");
		exit();
	}
...
<html>
<head>
    <title>Chain 2 Hotel Creator</title>
...
?>
    ...
    <form action="" method="post" class="form">
        ...
        <?php
        if(isset($_SESSION["ErrorCtwo"])){ // checks if there is an error message set
        echo '<p class = "statusMessage">' .$_SESSION["ErrorCtwo"].'</p>'; // Outputs error message to user
    }
        ?>
    </form>
