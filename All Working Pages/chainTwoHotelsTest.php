...
if($_SESSION["admin2"] == "yes"){
  echo '<li class ="nav-item"><a href="hotelCreatorOne.php">Hotel Creation</a></li>';
  echo '<li class ="nav-item"><a href="allReservationsOne.php">View All Reservations</a></li>';
}
?>
					<?php 
