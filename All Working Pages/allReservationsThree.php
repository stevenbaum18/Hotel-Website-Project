...
?>
      ...
      <ul class="nav navbar-nav navbar-right">
         <?php
                   ...
                   echo '<li class ="nav-item"><a href="hotelSignUp.php">Sign Up</a></li>';
                   echo '<li class ="nav-item"><a href="hotelLog.php">Login</a></li>';
                }
                else{echo'<li class ="nav-item"> <a href="hotelLogOut.php">Log Out</a></li>';
...
<table class="table table-dark">
  ...
  <tbody>
   <?php
    $chainCheckQuery = "SELECT id,username, hotelChain, hotelLocation, roomType, dateBooked, fromDate, toDate,price, amtRoom FROM `reservations` WHERE hotelChain = 'Chain 3'";
